...
<%@page import="wifi.com.controller.BMGroupEdit"%>
...
<body>
	...
	<form action="./bookmark-group-edit.do" method="post">
		<table>
			<tr>
				<th>북마크 이름</th>
		...
		<input type="hidden" name="bookmarkEdit"></input> 
		<input type="hidden" name="bookmarkId" value="<%=bookmark.getBookmarkId()%>"></input>
		<div>
